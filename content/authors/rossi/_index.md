...
social:
  - icon: envelope
    icon_pack: fas
    link: 'mailto:emanuele.rossi1909@gmail.com'
  - icon: twitter
    icon_pack: fab
    link: https://x.com/emaros96
    label: Follow me on Twitter
  - icon: graduation-cap
    icon_pack: fas
    link: https://scholar.google.com/citations?user=DHlkBOYAAAAJ
  - icon: github
    icon_pack: fab
    link: https://github.com/emalgorithm
  - icon: linkedin
    icon_pack: fab
    link: https://www.linkedin.com/in/emanuele-rossi/
  - icon: globe-americas
    icon_pack: fas
    link: https://emanuelerossi.co.uk/
organizations:
...
I’m a postdoctoral researcher in the [Gladia](https://gladia.di.uniroma1.it) group at **Sapienza University of Rome**, working with [Emanuele Rodolà](https://gladia.di.uniroma1.it/authors/rodola/). My research explores how **Machine Learning can help decode animal communication**, focusing on how multimodal models can reveal what wild animals communicate to one another, what this tells us about their intelligence and consciousness, and how such understanding can reshape our relationship with the natural world.
